...
import { Send, CheckCircle, Loader2, Mail, Phone, MessageSquare, Instagram } from 'lucide-react';
import {
  Select,
  SelectContent,
  SelectItem,
...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setIsSuccess(true);
      // Reset form after 3 seconds if needed, or keep success message
    }, 1500);
  };
            ...
            <div className="space-y-6 pt-4">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500">jaindesignsoff@gmail.com</p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="https://www.instagram.com/jaindesign.in/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-brand-green transition-colors">@jaindesign.in</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            {isSuccess ? (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-white rounded-3xl p-8 text-center animate-fade-in-up">
                    ...
                    <p className="text-gray-500 max-w-xs mx-auto">
                        Thank you for contacting Jain Designs. We have received your request and will be in touch shortly.
                    </p>
                    <button 
            ...
            <form onSubmit={handleSubmit} className={`space-y-6 transition-opacity duration-300 ${isSuccess ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
                ...
                <div className="space-y-2">
                    ...
                    >
                        ...
                        <SelectContent>
                            <SelectItem value="Standard Website">Standard Website (₹12k - ₹15k)</SelectItem>
                            <SelectItem value="E-commerce Store">E-commerce Store (₹25k - ₹30k)</SelectItem>
                            <SelectItem value="Custom Platform">Custom Platform (₹45k - ₹50k)</SelectItem>
